...
class __TwigTemplate_8e2e02ea03e810a15c3f7fbad7007e279686ab108649668dcc0c237c90b1a446 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        <div id=\"";
            ...
            ";
                // line 247
                echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 247, $this->source); })()), "context", [], "any", false, false, false, 247), 1);
                echo "
        </div>
        ...
        ";
                ...
                ";
                    // line 252
                    echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 252, $this->source); })()), "context", [], "any", false, false, false, 252), "exception", [], "any", false, false, false, 252), "trace", [], "any", false, false, false, 252), 1);
                    echo "
            </div>
        ";
                }
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "C:\\Users\\JHON PC\\Documents\\GitRepTests\\providers_app\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\logger.html.twig");
    }
}
