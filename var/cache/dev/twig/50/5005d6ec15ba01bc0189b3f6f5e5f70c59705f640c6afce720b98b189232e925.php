...
class __TwigTemplate_d89d284cf23abc4a8b39344f1a9d098e7ac7b4502047b8b9e8003a2a521524d5 extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["name"] => $context["event"]) {
                ...
                if (("__section__" != $context["name"])) {
                    ...
                    echo "\",
                            \"origin\": ";
                    // line 527
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "origin", [], "any", false, false, false, 527)), "js", null, true);
                    echo ",
                            \"starttime\": ";
                    // line 528
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "starttime", [], "any", false, false, false, 528)), "js", null, true);
                    echo ",
                            \"endtime\": ";
                    // line 529
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "endtime", [], "any", false, false, false, 529)), "js", null, true);
                    echo ",
                            \"duration\": ";
                    // line 530
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "duration", [], "any", false, false, false, 530)), "js", null, true);
                    echo ",
                            \"memory\": ";
                    // line 531
                    echo twig_escape_filter($this->env, twig_sprintf("%.1F", ((twig_get_attribute($this->env, $this->source, $context["event"], "memory", [], "any", false, false, false, 531) / 1024) / 1024)), "js", null, true);
                    echo ",
                            \"periods\": [";
                    // line 533
                    $context['_parent'] = $context;
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["period"]) {
                        // line 534
                        echo "{\"start\": ";
                        echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["period"], "starttime", [], "any", false, false, false, 534)), "js", null, true);
                        echo ", \"end\": ";
                        echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["period"], "endtime", [], "any", false, false, false, 534)), "js", null, true);
                        echo "}";
