...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ProviderRepository' => function () {
    return ($this->privates['App\Repository\ProviderRepository'] ?? $this->load('getProviderRepositoryService.php'));
}))));
